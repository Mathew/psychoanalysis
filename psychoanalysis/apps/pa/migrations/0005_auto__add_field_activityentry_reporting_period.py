...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityEntry.reporting_period'
        db.add_column(u'pa_activityentry', 'reporting_period',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pa.ReportingPeriod']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityEntry.reporting_period'
        db.delete_column(u'pa_activityentry', 'reporting_period_id')
