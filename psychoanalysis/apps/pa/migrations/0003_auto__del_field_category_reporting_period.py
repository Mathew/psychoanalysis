...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'ReportingPeriod'
        db.create_table(u'pa_reportingperiod_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reportingperiod', models.ForeignKey(orm[u'pa.reportingperiod'], null=False)),
            ('category', models.ForeignKey(orm[u'pa.category'], null=False))
        ))
        db.create_unique(u'pa_reportingperiod_categories', ['reportingperiod_id', 'category_id'])

        # Deleting field 'Category.reporting_period'
        db.delete_column(u'pa_category', 'reporting_period_id')


    def backwards(self, orm):
        # Removing M2M table for field categories on 'ReportingPeriod'
        db.delete_table('pa_reportingperiod_categories')


        # User chose to not deal with backwards NULL issues for 'Category.reporting_period'
        raise RuntimeError("Cannot reverse this migration. 'Category.reporting_period' and its values cannot be restored.")
    ...
    models = {
        ...
        u'pa.reportingperiod': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pa.Category']", 'symmetrical': 'False'}),
